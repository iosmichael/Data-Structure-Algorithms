...
import static exercises.Exercise1.binarySearch;
...
public class BinSearchTest {
    ...
    private static class MeasComp implements Comparable<MeasComp> {
        ...
        MeasComp(int kernel) { this.kernel = kernel; }
        
        public int compareTo(MeasComp o) {
            comparisons++;
            if (kernel < o.kernel) return -1;
            else if (kernel == o.kernel) return 0;
            else /* if (kernel > o.kernel) */ return 1;
        }
        @Override
        public boolean equals(Object o) {
            comparisons++;
            return o instanceof MeasComp && ((MeasComp) o).kernel == kernel;
        }
    }
    ...
    private void runSearch(int item) {
        ...
        if (result == -1)  {
            ...
            assertEquals("Incorrect result", msItem, workingCopy[result]);
        checkTampering();
    }
