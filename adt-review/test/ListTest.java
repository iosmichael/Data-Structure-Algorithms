...
public abstract class ListTest {
    ...
    public void insertEmpty() {
        reset();
        testList.insert(0, data[2]);
        assertEquals(testList.size(), 1);
        assertEquals(testList.get(0), data[2]);
    }
    ...
    public void insertFront() {
        reset();
        populate(8);
        testList.insert(0, data[8]);
        assertEquals(testList.size(), 9);
        assertEquals(testList.get(0), data[8]);
        for (int i = 0; i < 8; i++)
            assertEquals(testList.get(i+1), data[i]);
    }
    ...
    public void insertMiddle() {
        reset();
        populate(8);
        testList.insert(4, data[8]);
        assertEquals(testList.size(), 9);
        for (int i = 0; i < 4; i++)
            assertEquals(testList.get(i), data[i]);
        assertEquals(testList.get(4), data[8]);
        for (int i = 5; i < 9; i++)
            assertEquals(testList.get(i), data[i-1]);
    }
    ...
    public void insertEnd() {
        reset();
        populate(8);
        testList.insert(8, data[8]);
        assertEquals(testList.size(), 9);
        for (int i = 0; i < 8; i++)
            assertEquals(testList.get(i), data[i]);
        assertEquals(testList.get(8), data[8]);
    }
